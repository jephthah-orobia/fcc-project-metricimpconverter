...
suite('Unit Tests', function () {
    const { getNum, getUnit, getReturnUnit, spellOutUnit, convert } = convertHandler;

    let valid_units = ['gal', 'L', 'km', 'mi', 'lbs', 'kg', 'KG', 'GaL', 'GAL', 'l', 'KM', 'Km', 'mi'];

    let valid_nums = ['', '3', '1.3', '1/2', '2.65/5', '32.12/321.12', '321/1.23'];
    ...
    test('convertHandler should correctly read a fraction input', function (done) {
    ...
    test('convertHandler should correctly read a fraction input with a decimal', function (done) {
    ...
    test('convertHandler should correctly return an error on a double-fraction', function (done) {
        ...
        assert.Throw(() => getNum('1.2/2.2/1km'));
        done();
    });
    ...
    test('convertHandler should correctly return an error for an invalid input unit', function (done) {
        ...
        assert.Throw(() => getUnit('3.2 grams'));
        done();
    });
